...
const INTERACTIVE_WIDGET_RULES = [
  ...
  '8. **不要把整段 JS 包在 try/catch 里** —— 这会吞掉真实的逻辑 bug 让 widget 看起来"渲染成功但内容是空的"。让错误抛出，iframe bridge 的 error 监听器会显示醒目红色覆盖层，反而方便排查',
  '9. **写完代码自己脑中跑一遍**：',
  ...
  '10. **保持简单**：能用 200 行做出来就别写 500 行。多功能 ≠ 好 widget；可工作 + 教学清晰才是好 widget',
  '',
